...
**spring** 프레임워크 4.0 버전을 사용하였고 실제 쇼핑몰의 상품 상세페이지와 장바구니에서 상품 옵션 선택 및 수량 변경 등의 기능을 **jquery** 구현하였습니다. 상품 게시판 정렬 순서, 상품 수량 변경등의 기능을 **ajax**를 이용해서 비동기적 동작하도록 구현하였습니다. 팀원으로써 제가 담당한 파트는 아래와 같습니다. 

담당 파트 - 상품 게시판 / 상세 페이지 / 주문 및 결제 / 장바구니
## INDEX
